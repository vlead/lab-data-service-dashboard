...
def create_role():
    ...
    try:
        ...
        return jsonify(success=False, message="This role already exists"), 400
...
def delete_user():
    ...
    try:
        ...
        return jsonify(success=False, message="could'nt delete the user"), 400
    return jsonify(success=True)
#+END_SRC
** Delete Role
...
def delete_role():
    ...
    try:
        ...
        return jsonify(success=False, message="could'nt delete"), 400
    return jsonify(success=True)
...
@mod_users.route('/update_user', methods=['POST'])
@login_required
def update_user():
    try:
        email = request.args['email']
