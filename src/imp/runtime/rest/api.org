...
** Guest Home
#+NAME: guest_home
#+BEGIN_SRC html :tangle templates/guest_home.html
<!DOCTYPE html>
<html>
<head>
    <title>HOME</title>
...
** Admin Home
#+NAME: admin_home
#+BEGIN_SRC html :tangle templates/admin_home.html
<!DOCTYPE html>
<html>
<head>
    <title>HOME</title>
...
** Not Autherized Page
#+NAME: auth_req
#+BEGIN_SRC html :tangle templates/auth_req.html
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
** Error 404 page
#+NAME: 404
#+BEGIN_SRC html :tangle templates/404.html
<!DOCTYPE html>
<html lang="en-US">
<head>
    <meta charset="UTF-8">
...
#+NAME: login
#+BEGIN_SRC javascript :tangle static/js/login.js
...
error is shown that user is not availed to LDS.
#+NAME: guest
#+BEGIN_SRC javascript :tangle static/js/guest.js
...
.auth-container {
    ...
    width: 100%;
    height: 100%;
    background: url(../images/bg/auth_req_bg.png);
...
.header {
    ...
    width: 100%;
    height: 100%;
    background: url(../images/bg/login_bg.jpg) no-repeat center center scroll;
