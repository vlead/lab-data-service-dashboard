...
apt-get install -y python-dev python-pip libmysqlclient-dev python-setuptools apache2 libapache2-mod-wsgi libffi-dev build-essential libssl-dev libxml2-dev libxslt1-dev build-essential 
if [[ $? -ne 0 ]]; then
