...
#+BEGIN_SRC sh :tangle setup.sh :eval no
  ...
  pip install Flask Flask-SQLAlchemy oursql requests flask-cors\
      Werkzeug urllib3 SQLAlchemy six requests-oauthlib asn1crypto\
      certifi cffi chardet click client cryptography enum34 Flask\
      Flask-Cors Flask-Login Flask-OAuth Flask-OAuthlib\
      Flask-Testing http httplib2 idna ipaddress itsdangerous\
      Jinja2 MarkupSafe oauth2 oauthlib oursql pycparser\
      pyOpenSSL PyYAML requests flask-cors\
      Flask-SQLAlchemy argparse wsgiref flask_mail
