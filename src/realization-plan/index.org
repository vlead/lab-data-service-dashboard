...
* Milestones Snapshot
  ...
  |      | Mapping     |                                                                                                              |      |        |        |
  |------+-------------+--------------------------------------------------------------------------------------------------------------+------+--------+--------|
  |    1 |             | [[https://github.com/vlead/lab-data-service-dashboard/milestone/1][Backend API's for Dashboad to login and logout pages with default admin and guest roles]]                      |      | Closed | [[https://github.com/vlead/lab-data-service-dashboard/milestone/1?closed=1][ref]]    |
  |------+-------------+--------------------------------------------------------------------------------------------------------------+------+--------+--------|
  |    2 |             | [[https://github.com/vlead/lab-data-service-dashboard/milestone/2][Implementation of Front End with Login, Logout, Admin and Guest Dashboards as Single Page Applications (SPA)]] |      | Closed | [[https://github.com/vlead/lab-data-service-dashboard/milestone/2?closed=1][ref]]    |
  |------+-------------+--------------------------------------------------------------------------------------------------------------+------+--------+--------|
  |    3 |             | [[https://github.com/vlead/lab-data-service-dashboard/milestone/3][Implementation of Front End Dashboard for LDS as Single Page Application (SPA)]]                               |      | Closed | [[https://github.com/vlead/lab-data-service-dashboard/milestone/3?closed=1][ref]]    |
  |      |             |                                                                                                              |      |        |        |
  |------+-------------+--------------------------------------------------------------------------------------------------------------+------+--------+--------|
  #+TBLFM: $1=@#-1
