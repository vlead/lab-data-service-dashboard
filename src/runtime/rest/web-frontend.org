...
#+BEGIN_SRC js
var select = document.querySelectorAll('[class$="lab-exp"]');
  [].forEach.call(select, function (button) {
    $('#'+button.id).on('click', function(clickEvent) {
       	var developer = [];
	      var hostings_info = [];
    ...
    $('#add-'+id+'-developer-id-select :selected').each(function(){
	 ...
	 $('#add-'+id+'-container #new-hosting-'+ed+'-div').find("li").each(function(){
              var input = $(this).find('input');
              var new_hos={};
  ...
  $('#add-'+id+'-asset-id-select :selected').each(function(){
	 ...
	 $('#add-'+id+'-container #new-asset-'+ed+'-div').find("li").each(function(){
              var input = $(this).find('input');
              var new_ass={};
...
#+BEGIN_SRC js
/* Worthy are those who use switch case to make it short. Alas, I am not one of them. */
var new_add_data = {
  developer: function() {
