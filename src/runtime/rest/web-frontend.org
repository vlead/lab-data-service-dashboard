...
** Add User
Event handler is added to the =add-user= button which takes the 
data from the input boxes and makes an AJAX call to the backend
server. Bases on the responce it shows the success or error 
message.
...
#+END_SRC
** Add Role
Event handler is added to the =add-role= button which takes the 
data from the input boxes and makes an AJAX call to the backend
server. Bases on the responce it shows the success or error 
message.
...
#+END_SRC
** User Tables
All the users are populated. Each row contains the =name=, =email=
and =role= of the user. Also contains an =Edit= button and a =Delete= 
...
Event handlers are added to all the =update= and =remove= buttons.
...
#+END_SRC
** Update Role Tables
All the roles are populated. Each row contains the =name= of the role.
It  Also contains a =Delete= button to delete the respective role.
              ...
              "elements":[
                ...
                },
                {
                  ...
                  "elements":[
                    {
                      "typeofdiv":"label",
                      "id":"new-experiment-integration-level",
                      "innerText":"Integration Level:"
                    },
                    {
                      "typeofdiv":"input",
