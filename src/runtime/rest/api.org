...
def update_user():
    ...
    elif user_checkupdate is not None:
...
<div id="side-nav-container" class="sidenav">
  	<div class="list-group table-of-contents">
		<button id="home-btn-add-user" class="list-group-item"> Add User </button>
		<button id="home-btn-add-role" class="list-group-item"> Add Role </button>
		<button id="home-btn-show-users" class="list-group-item"> Show Users </button>
		<button id="home-btn-show-roles" class="list-group-item"> Show Roles </button>
  	</div>
</div>
<div id=main>
...
#+NAME: style
#+BEGIN_SRC :tangle app/static/css/style.css 
.sidenav {
height: 100%;
width: 250px;
z-index: 1;
