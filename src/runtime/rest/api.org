...
#+NAME: check_email
#+BEGIN_SRC python
@api.route('/check_valid', methods=['POST'])
def check_valid():
	try:
...
from runtime.rest.app.users.api import api as api
from runtime.rest.app.users.db import User, Roles
from runtime.rest.app import app, db, login_manager, requires_guest_auth, requires_admin_auth
...
from app import app, db, login_manager, requires_guest_auth, requires_admin_auth
from app.users.db import User, Roles
import os
import json
import re
import time
