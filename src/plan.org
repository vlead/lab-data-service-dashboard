...
|      |                        | Issues | Effort   | Effort |        |          |
|------+------------------------+--------+----------+--------+--------+----------|
|   1. | Implementation         | [[https://github.com/vlead/lab-data-service-dashboard/issues/9][#9]]     |          |        | Done   | Yahnit,  |
|      | of Admin Dashboard     |        |          |        |        | Utkarsh  |
|------+------------------------+--------+----------+--------+--------+----------|
|   2. | Implementation         | [[https://github.com/vlead/lab-data-service-dashboard/issues/10][#10]]    |          |        | Done   | Yahnit,  |
|      | of 'Guest' Dashboard   |        |          |        |        | Utkarsh  |
|------+------------------------+--------+----------+--------+--------+----------|
|   3. | Re-Implementation      | [[https://github.com/vlead/lab-data-service-dashboard/issues/14][#14]]    |          |        | Done   | Utkarsh  |
...
|------+------------------------+--------+----------+--------+--------+----------|
|   5. | Implement Event        | [[https://github.com/vlead/lab-data-service-dashboard/issues/16][#16]]    |          |        | Done   | Yahnit   |
|      | handlers for all       |        |          |        |        |          |
|      | CRUD operations        |        |          |        |        |          |
|      | in front end           |        |          |        |        |          |
|------+------------------------+--------+----------+--------+--------+----------|
